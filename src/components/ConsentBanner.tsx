...
export default function ConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-16 z-30 mx-auto max-w-md p-3">
      <div className="animate-fade-in-up rounded-2xl bg-ink p-4 text-chalk shadow-xl">
        <p className="text-sm">
        ...
        <div className="mt-3 flex gap-2">
          <button
            onClick={() => decide("yes")}
            className="flex-1 rounded-lg bg-klein py-2 text-sm font-semibold transition-transform duration-150 active:scale-95"
          >
            Accepter
          </button>
          <button
            onClick={() => decide("no")}
            className="flex-1 rounded-lg border border-chalk/30 py-2 text-sm transition-transform duration-150 active:scale-95"
          >
            Refuser
          </button>
        </div>
